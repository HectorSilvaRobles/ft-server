...
app.use(cors({credentials: true, origin: 'https://www.abfutboltraining.com. https://localhost:3000' }));

app.use(function(req, res, next) {
        // res.header("Access-Control-Allow-Origin","http://127.0.0.1:3000");
        res.header("Access-Control-Allow-Origin", "https://www.abfutboltraining.com/","https://www.abfutboltraining.com", 'https://localhost:3000');
